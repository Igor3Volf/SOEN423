...
class Replica_2 extends Thread implements Runnable {
	...
	public Replica_2() throws Exception 
	{
		...
		serverSocket = new MulticastSocket(2010);
		this.csCA = new CenterServer("Canadian", PATH, 2011);
		this.csUS = new CenterServer("American", PATH, 2012);
		this.csUK = new CenterServer("English", PATH, 2013);
		idGen.start();
